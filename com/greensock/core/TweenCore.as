...
/**
 * TweenCore is the base class for all TweenMax, TweenMax, TimelineLite, and TimelineMax classes and 
 ...
 */
	public class TweenCore {
		...
		public var initted:Boolean; 
		 /** The parent timeline on which the tween/timeline is placed. By default, it uses the TweenMax.rootTimeline (or TweenMax.rootFramesTimeline for frames-based tweens/timelines). **/
		...
		public function TweenCore(duration:Number=0, vars:Object=null) {
			...
			var tl:SimpleTimeline = (this.vars.timeline is SimpleTimeline) ? this.vars.timeline : (this.vars.useFrames) ? TweenMax.rootFramesTimeline : TweenMax.rootTimeline;
...
//---- GETTERS / SETTERS ------------------------------------------------------------
		 ...
		 * which includes repeats and repeatDelays. Since TweenMax and TimelineLite don't offer 
		 ...
		 * which does NOT include repeats and repeatDelays. Since TweenMax and TimelineLite don't offer 
		 * <code>repeat</code> and <code>repeatDelay</code> functionality, <code>currentTime</code> 
		 * and <code>totalTime</code> will always be the same but in TweenMax or TimelineMax, they 
		 * could be different. For example, if a TimelineMax instance has a duration 
		 * of 5 a repeat of 1 (meaning its <code>totalDuration</code> is 10), at the end of the second cycle, 
