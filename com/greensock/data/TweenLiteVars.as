 ...
 */	 
	public class TweenMaxVars {
		...
		protected function _set(property:String, value:*, requirePlugin:Boolean=false):TweenMaxVars {
			...
			if (requirePlugin && !(property in TweenMax.plugins)) {
				trace("WARNING: you must activate() the " + property + " plugin in order for the feature to work in TweenMax. See http://www.greensock.com/TweenMax/#plugins for details.");
			}
			return this;
		}
...
//---- BUILT-IN SPECIAL PROPERTIES (NO PLUGIN ACTIVATION REQUIRED) --------------------------------------------------------------
		 ...
		 * be initted once for TweenMax, like OverwriteManager.init(). TweenMax, TimelineLite, and 
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * it returns the destination value, TweenMax/Max will take care of adjusting things 
		 * on the fly.<br /><br />
		 * 
		 ...
		 * TweenMax/Max needs 4 pieces of information:
		 * <ol>
