 ...
 * Notes: <br />
 * <ul>
 * 		<li>TweenMax does <b>NOT</b> have the internal algorithms in place to take advantage of optimized eases at this time (to conserve file size).</li>
 ...
 */
	public class FastEase {
		...
		public static function activateEase(ease:Function, type:int, power:uint):void {
			TweenMax.fastEaseLookup[ease] = [type, power];
		}
